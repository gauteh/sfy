...
CREATE TABLE IF NOT EXISTS omb_events (dev TEXT NOT NULL, account TEXT, event INTEGER PRIMARY KEY AUTOINCREMENT, received UNSIGNED BIGINT NOT NULL, data BLOB);
